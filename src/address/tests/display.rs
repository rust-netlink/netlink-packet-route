...
fn test_address_family_display() {
    ...
    assert_eq!(AddressFamily::Other(255).to_string(), "unknown");
}
...
fn test_address_scope_display() {
    assert_eq!(AddressScope::Universe.to_string(), "global");
    ...
    assert_eq!(AddressScope::Other(42).to_string(), "unknown");
}
...
fn test_address_protocol_display() {
    ...
    assert_eq!(AddressProtocol::Other(42).to_string(), "unknown");
}
