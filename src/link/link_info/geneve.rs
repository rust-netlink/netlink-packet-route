...
impl Nla for InfoGeneve {
    fn value_len(&self) -> usize {
        ...
        match self {
            ...
            Port(_) => 2,
            CollectMetadata(_) | InnerProtoInherit(_) => 0,
    ...
    fn emit_value(&self, buffer: &mut [u8]) {
        ...
        match self {
            ...
            CollectMetadata(_value) | InnerProtoInherit(_value) => (),
            UdpCsum(value)
    ...
    fn kind(&self) -> u16 {
        ...
        match self {
            ...
            CollectMetadata(_) => IFLA_GENEVE_COLLECT_METADATA,
            ...
            Df(_) => IFLA_GENEVE_DF,
            InnerProtoInherit(_) => IFLA_GENEVE_INNER_PROTO_INHERIT,
            Other(nla) => nla.kind(),
        }
    }
}
...
impl<'a, T: AsRef<[u8]> + ?Sized> Parseable<NlaBuffer<&'a T>> for InfoGeneve {
    fn parse(buf: &NlaBuffer<&'a T>) -> Result<Self, DecodeError> {
        ...
        Ok(match buf.kind() {
            ...
            IFLA_GENEVE_COLLECT_METADATA => CollectMetadata(true),
            ...
            IFLA_GENEVE_DF => Df(parse_u8(payload)
                ...
                .into()),
            IFLA_GENEVE_INNER_PROTO_INHERIT => InnerProtoInherit(true),
            kind => Other(
