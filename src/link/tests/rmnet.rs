...
// nlmon capture kernel reply netlink packet of ip link show rm0
#[test]
fn test_parsing_link_rmnet() {
    let raw = vec![
        0x00, 0x00, 0x07, 0x02, 0x0d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00, 0x72, 0x6d, 0x30, 0x00,
        0x08, 0x00, 0x0d, 0x00, 0xe8, 0x03, 0x00, 0x00, 0x05, 0x00, 0x10, 0x00,
        0x02, 0x00, 0x00, 0x00, 0x05, 0x00, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x05, 0x00, 0x43, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x04, 0x00,
        0xd8, 0x05, 0x00, 0x00, 0x08, 0x00, 0x32, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x08, 0x00, 0x33, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x1b, 0x00,
        ...
        0x00, 0x00, 0x01, 0x00, 0x08, 0x00, 0x3c, 0x00, 0xff, 0xff, 0x00, 0x00,
        0x08, 0x00, 0x42, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x20, 0x00,
        ...
        0x06, 0x00, 0x44, 0x00, 0x10, 0x00, 0x00, 0x00, 0x06, 0x00, 0x45, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x27, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x0c, 0x00, 0x2b, 0x00, 0x05, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x28, 0x00, 0x12, 0x00, 0x0a, 0x00, 0x01, 0x00, 0x72, 0x6d, 0x6e, 0x65,
        0x74, 0x00, 0x00, 0x00, 0x18, 0x00, 0x02, 0x00, 0x06, 0x00, 0x01, 0x00,
        0x0a, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00,
        0xff, 0xff, 0xff, 0xff, 0x08, 0x00, 0x05, 0x00, 0x0a, 0x00, 0x00, 0x00,
        ...
        0x14, 0x00, 0x05, 0x00, 0xff, 0xff, 0x00, 0x00, 0x01, 0x37, 0x04, 0x00,
        0x75, 0x6d, 0x00, 0x00, 0xe8, 0x03, 0x00, 0x00, 0xf4, 0x00, 0x02, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0xd8, 0x05, 0x00, 0x00,
        0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
    ...
    let expected = LinkMessage {
        header: LinkHeader {
            ...
            index: 13,
            link_layer_type: LinkLayerType::Rawip,
            flags: LinkFlags::empty(),
            change_mask: LinkFlags::empty(),
        },
        attributes: vec![
            LinkAttribute::IfName("rm0".to_string()),
            ...
            LinkAttribute::Other(DefaultNla::new(68, vec![16, 0])),
            ...
            LinkAttribute::LinkInfo(vec![
                ...
                LinkInfo::Data(InfoData::RmNet(vec![
                    InfoRmNet::MuxId(10),
                    InfoRmNet::Flags(InfoRmNetFlags {
                        flags: RmNetFlags::IngressDeaggregation,
                        mask: RmNetFlags::from_bits_retain(0xffffffff),
                    }),
                ])),
            ]),
            LinkAttribute::Link(10),
