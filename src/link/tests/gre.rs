...
#[test]
fn test_create_erspan_v1() {
    // This is nlmon capture for `ip link add name foo type erspan \
    //     local 192.168.1.1 remote 192.168.1.2 key 123 seq \
    //     erspan_ver 1 erspan 123`
    // on Linux kernel 7.1.6 with iproute2 version 7.1.0
    let raw: Vec<u8> = vec![
        0x00, // interface family AF_UNSPEC
        0x00, // reserved
        0x00, 0x00, // link layer type 0
        ...
        0x0b, 0x00, // length 12
        0x01, 0x00, // IFLA_INFO_KIND 1
        0x65, 0x72, 0x73, 0x70, 0x61, 0x6e, 0x00,
        0x00, // erspan\0 + padding
        0x84, 0x00, // length 132
        0x02, 0x00, // IFLA_INFO_DATA 2
        0x08, 0x00, // length 8
        0x04, 0x00, // IFLA_GRE_IKEY 4
        ...
        0x00, 0x00, 0x00, // padding
        0x08, 0x00, // length 8
        0x15, 0x00, // IFLA_GRE_ERSPAN_INDEX 21
    ...
    let expected = LinkMessage {
        attributes: vec![
            LinkAttribute::IfName("foo".to_string()),
            LinkAttribute::LinkInfo(vec![
                LinkInfo::Kind(InfoKind::ErSpan),
                LinkInfo::Data(InfoData::ErSpan(vec![
                    InfoGre::IKey(123),
                    InfoGre::OKey(123),
                    InfoGre::IFlags(GreIOFlags::Key | GreIOFlags::Seq),
                    InfoGre::OFlags(GreIOFlags::Key | GreIOFlags::Seq),
                    InfoGre::Local(Ipv4Addr::new(192, 168, 1, 1)),
                    InfoGre::Remote(Ipv4Addr::new(192, 168, 1, 2)),
                    InfoGre::PathMTUDiscovery(true),
                    InfoGre::Tos(0),
                    InfoGre::Ttl(0),
                    InfoGre::FwMask(0),
...
#[test]
fn test_create_erspan_v2() {
    // This is nlmon capture for `ip link add name foo type erspan \
    //     local 192.168.2.1 remote 192.168.2.2 key 456 seq \
    ...
    let raw: Vec<u8> = vec![
        ...
        0x08, 0x00, // length 8
        0x07, 0x00, // IFLA_GRE_REMOTE 7
        0xc0, 0xa8, 0x02, 0x02, // 192.168.2.2
        0x05, 0x00, // length 5
        0x0a, 0x00, // IFLA_GRE_PMTUDISC 10
        0x01, // 1
        0x00, 0x00, 0x00, // padding
        ...
        0x00, 0x00, 0x00, // padding
        0x05, 0x00, // length 5
        0x17, 0x00, // IFLA_GRE_ERSPAN_DIR 23
        0x01, // egress
        0x00, 0x00, 0x00, // padding
        0x06, 0x00, // length 6
        0x18, 0x00, // IFLA_GRE_ERSPAN_HWID 24
        0x11, 0x00, // 17
        0x00, 0x00, // padding
        0x06, 0x00, // length 6
        0x0e, 0x00, // IFLA_GRE_ENCAP_TYPE 14
        ...
        attributes: vec![
            ...
            LinkAttribute::LinkInfo(vec![
                ...
                LinkInfo::Data(InfoData::ErSpan(vec![
                    ...
                    InfoGre::IFlags(GreIOFlags::Key | GreIOFlags::Seq),
                    InfoGre::OFlags(GreIOFlags::Key | GreIOFlags::Seq),
                    InfoGre::Local(Ipv4Addr::new(192, 168, 2, 1)),
                    InfoGre::Remote(Ipv4Addr::new(192, 168, 2, 2)),
                    InfoGre::PathMTUDiscovery(true),
                    InfoGre::Tos(0),
                    InfoGre::Ttl(0),
                    InfoGre::FwMask(0),
                    InfoGre::ErSpanVer(2),
                    InfoGre::ErSpanDir(ErSpanDir::Egress),
                    InfoGre::ErSpanHwId(17),
                    InfoGre::EncapType(GreEncapType::default()),
                    InfoGre::EncapFlags(GreEncapFlags::default()),
                    InfoGre::SourcePort(0),
                    InfoGre::DestinationPort(0),
...
#[test]
fn test_create_ip6erspan_v1() {
    // This is nlmon capture for `ip link add name foo type ip6erspan \
    //     local fc00::1 remote fc00::2 key 123 seq \
    //     erspan_ver 1 erspan 123`
    // on Linux kernel 7.1.6 with iproute2 version 7.1.0
    let raw: Vec<u8> = vec![
        0x00, // interface family AF_UNSPEC
        ...
        0x03, 0x00, // device name
        0x66, 0x6f, 0x6f, 0x00, // foo\0
        0xb8, 0x00, // length 184
        0x12, 0x00, // IFLA_LINKINFO 18
        0x0e, 0x00, // length 14
        0x01, 0x00, // IFLA_INFO_KIND 1
        0x69, 0x70, 0x36, 0x65, 0x72, 0x73, 0x70, 0x61, 0x6e, 0x00, 0x00,
        0x00, // ip6erspan\0 + padding
        0xa4, 0x00, // length 164
        0x02, 0x00, // IFLA_INFO_DATA 2
        0x08, 0x00, // length 8
        0x04, 0x00, // IFLA_GRE_IKEY 4
    ...
    let expected = LinkMessage {
        attributes: vec![
            LinkAttribute::IfName("foo".to_string()),
            LinkAttribute::LinkInfo(vec![
                LinkInfo::Kind(InfoKind::Ip6ErSpan),
                LinkInfo::Data(InfoData::Ip6ErSpan(vec![
                    InfoGre6::IKey(123),
                    InfoGre6::OKey(123),
                    InfoGre6::IFlags(GreIOFlags::Key | GreIOFlags::Seq),
                    InfoGre6::OFlags(GreIOFlags::Key | GreIOFlags::Seq),
                    InfoGre6::Local(Ipv6Addr::new(
                        0xfc00, 0, 0, 0, 0, 0, 0, 0x01,
                    )),
                    InfoGre6::Remote(Ipv6Addr::new(
...
#[test]
fn test_create_ip6erspan_v2() {
    // This is nlmon capture for `ip link add name foo type ip6erspan \
    //     local fd00::1 remote fd00::2 key 456 seq \
    ...
    let raw: Vec<u8> = vec![
        ...
        0x14, 0x00, // length 20
        0x06, 0x00, // IFLA_GRE_LOCAL 6
        0xfd, 0x00, 0x00, 0x00, // fd00::1
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
        0x14, 0x00, // length 20
        0x07, 0x00, // IFLA_GRE_REMOTE 7
        0xfd, 0x00, 0x00, 0x00, // fd00::2
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
        0x05, 0x00, // length 5
        0x08, 0x00, // IFLA_GRE_TTL 8
        0x40, // 64
        ...
        attributes: vec![
            ...
            LinkAttribute::LinkInfo(vec![
                ...
                LinkInfo::Data(InfoData::Ip6ErSpan(vec![
                    ...
                    InfoGre6::OFlags(GreIOFlags::Key | GreIOFlags::Seq),
                    InfoGre6::Local(Ipv6Addr::new(
                        0xfd00, 0, 0, 0, 0, 0, 0, 0x01,
                    )),
                    InfoGre6::Remote(Ipv6Addr::new(
                        0xfd00, 0, 0, 0, 0, 0, 0, 0x02,
                    )),
                    InfoGre6::Ttl(64),
                    InfoGre6::EncapLimit(4),
                    InfoGre6::FlowLabel(0),
                    ...
                    InfoGre6::ErSpanDir(ErSpanDir::Ingress),
                    InfoGre6::ErSpanHwId(17),
                    InfoGre6::EncapType(GreEncapType::default()),
                    // enabled by default for IPv6
                    InfoGre6::EncapFlags(GreEncapFlags::Checksum6),
                    InfoGre6::SourcePort(0),
