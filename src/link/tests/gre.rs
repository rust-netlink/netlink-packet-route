...
use crate::link::{
    GreEncapFlags, GreEncapType, GreIOFlags, InfoData, InfoGreTap, InfoGreTap6,
    InfoGreTun, InfoGreTun6, InfoKind, LinkAttribute, LinkInfo, LinkMessage,
    LinkMessageBuffer,
};
        ...
        attributes: vec![
            ...
            LinkAttribute::LinkInfo(vec![
                ...
                LinkInfo::Data(InfoData::GreTap6(vec![
                    InfoGreTap6::IKey(42),
                    InfoGreTap6::OKey(42),
                    InfoGreTap6::IFlags(GreIOFlags::Key),
                    InfoGreTap6::OFlags(GreIOFlags::Key),
                    InfoGreTap6::Local(Ipv6Addr::new(
                        0xfc00, 0, 0, 0, 0, 0, 0, 0x01,
                    )),
                    InfoGreTap6::Remote(Ipv6Addr::new(
                        0xfc00, 0, 0, 0, 0, 0, 0, 0x02,
                    )),
                    InfoGreTap6::Ttl(64),
                    InfoGreTap6::EncapLimit(2),
                    InfoGreTap6::FlowLabel(0x42),
                    InfoGreTap6::Flags(0),
                    InfoGreTap6::FwMask(0),
                    InfoGreTap6::Other(DefaultNla::new(22, vec![0x01])),
                    InfoGreTap6::EncapType(GreEncapType::default()),
                    // enabled by default for IPv6
                    InfoGreTap6::EncapFlags(GreEncapFlags::Checksum6),
                    InfoGreTap6::SourcePort(4242),
                    InfoGreTap6::DestinationPort(4242),
                ])),
            ]),
        ],
        ..Default::default()
        ...
        attributes: vec![
            ...
            LinkAttribute::LinkInfo(vec![
                ...
                LinkInfo::Data(InfoData::GreTap(vec![
                    InfoGreTap::IKey(42),
                    InfoGreTap::OKey(42),
                    InfoGreTap::IFlags(GreIOFlags::Key),
                    InfoGreTap::OFlags(GreIOFlags::Key),
                    InfoGreTap::Local(Ipv4Addr::new(192, 0, 2, 1)),
                    InfoGreTap::Remote(Ipv4Addr::new(192, 0, 2, 1)),
                    InfoGreTap::PathMTUDiscovery(true), // enabled by default
                    InfoGreTap::Tos(0),
                    InfoGreTap::Ttl(64),
                    InfoGreTap::FwMask(0),
                    InfoGreTap::EncapType(GreEncapType::default()),
                    InfoGreTap::EncapFlags(GreEncapFlags::default()),
                    InfoGreTap::SourcePort(4242),
                    InfoGreTap::DestinationPort(4242),
                ])),
            ]),
        ],
        ..Default::default()
