...
use crate::{
    link::{
        link_flag::LinkFlags, AfSpecInet, AfSpecInet6, AfSpecMctp,
...
// nlmon capture kernel reply netlink packet of ip link show wwan1
#[test]
fn test_parsing_link_wwan_show() {
    let raw = vec![
        0x00, 0x00, 0xfe, 0xff, 0x0e, 0x00, 0x00, 0x00, 0x90, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x0a, 0x00, 0x03, 0x00, 0x77, 0x77, 0x61, 0x6e,
        ...
        0x1c, 0x00, 0x12, 0x00, 0x09, 0x00, 0x01, 0x00, 0x77, 0x77, 0x61, 0x6e,
        0x00, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x02, 0x00, 0x08, 0x00, 0x01, 0x00,
        0x01, 0x00, 0x00, 0x00, 0x09, 0x00, 0x06, 0x00, 0x6e, 0x6f, 0x6f, 0x70,
        0x00, 0x00, 0x00, 0x00, 0xd4, 0x01, 0x1a, 0x00, 0x14, 0x00, 0x2d, 0x00,
        0x08, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x05, 0x00, 0x02, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x8c, 0x00, 0x02, 0x00, 0x88, 0x00, 0x01, 0x00,
        ...
        0x14, 0x00, 0x05, 0x00, 0xff, 0xff, 0x00, 0x00, 0xc0, 0x57, 0x90, 0x01,
        0xa7, 0x56, 0x00, 0x00, 0xe8, 0x03, 0x00, 0x00, 0xf4, 0x00, 0x02, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0xdc, 0x05, 0x00, 0x00,
        0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
        0x01, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xa0, 0x0f, 0x00, 0x00,
        0xe8, 0x03, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0xa3, 0x02, 0x00,
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x0a, 0x00, 0x38, 0x00, 0x77, 0x77, 0x61, 0x6e,
        0x31, 0x00, 0x00, 0x00, 0x04, 0x00, 0x3e, 0x80, 0x04, 0x00, 0x41, 0x80,
    ];
    ...
    let expected = LinkMessage {
        ...
        attributes: vec![
            LinkAttribute::IfName("wwan1".to_string()),
            ...
            LinkAttribute::LinkInfo(vec![
                LinkInfo::Kind(InfoKind::Wwan),
                LinkInfo::Data(InfoData::Wwan(vec![InfoWwan::LinkId(1)])),
            ]),
            LinkAttribute::Qdisc("noop".to_string()),
            LinkAttribute::AfSpecUnspec(vec![
                AfSpecUnspec::Mctp(vec![
                    AfSpecMctp::Net(1),
                    AfSpecMctp::PhysBinding(MctpPhysBinding::Other(0)),
                ]),
            ...
            LinkAttribute::ParentDevName("wwan1".to_string()),
...
// nlmon capture iproute2 sent netlink packet of:
//  sudo ip link add wwan0p parentdev wwan0 type wwan linkid 15
#[test]
fn test_parsing_link_wwan_add() {
    let raw = vec![
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x0a, 0x00, 0x38, 0x00, 0x77, 0x77, 0x61, 0x6e,
        0x30, 0x00, 0x00, 0x00, 0x0b, 0x00, 0x03, 0x00, 0x77, 0x77, 0x61, 0x6e,
        0x30, 0x70, 0x00, 0x00, 0x1c, 0x00, 0x12, 0x00, 0x09, 0x00, 0x01, 0x00,
        0x77, 0x77, 0x61, 0x6e, 0x00, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x02, 0x00,
    ...
    let expected = LinkMessage {
        ...
        attributes: vec![
            LinkAttribute::ParentDevName("wwan0".to_string()),
            LinkAttribute::IfName("wwan0p".to_string()),
            LinkAttribute::LinkInfo(vec![
                LinkInfo::Kind(InfoKind::Wwan),
                LinkInfo::Data(InfoData::Wwan(vec![InfoWwan::LinkId(15)])),
            ]),
        ],
    };
