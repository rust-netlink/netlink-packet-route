...
use crate::{
    link::{
        ...
        BridgeMulticastRouterType, BridgePortState, BridgeStpMode,
        BridgeStpState, BridgeVlanInfo, BridgeVlanInfoFlags,
...
fn test_parse_link_bridge_no_extention_mask() {
    let raw = vec![
        ...
        0x00, 0x00, 0x00, 0x00, 0xa4, 0x01, 0x1a, 0x00, 0x8c, 0x00, 0x02, 0x00,
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x01, 0x00, 0x00, 0x00, 0x14, 0x01, 0x0a, 0x00, 0x08, 0x00, 0x01, 0x00,
...
#[test]
fn test_parse_link_bridge_stp_mode() {
    // nlmon capture (netlink message header removed) of the kernel emitted
    // RTM_NEWLINK message (brstp0) of command:
    // `ip link add brstp0 type bridge stp_mode kernel` and
    // `ip link show brstp0`
    let raw: Vec<u8> = vec![
        0x00, 0x00, 0x01, 0x00, 0x0c, 0x00, 0x00, 0x00, 0x02, 0x10, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x0b, 0x00, 0x03, 0x00, 0x62, 0x72, 0x73, 0x74,
        0x70, 0x30, 0x00, 0x00, 0x08, 0x00, 0x0d, 0x00, 0xe8, 0x03, 0x00, 0x00,
        0x05, 0x00, 0x10, 0x00, 0x02, 0x00, 0x00, 0x00, 0x05, 0x00, 0x11, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x43, 0x00, 0x01, 0x00, 0x00, 0x00,
        0x08, 0x00, 0x04, 0x00, 0xdc, 0x05, 0x00, 0x00, 0x08, 0x00, 0x32, 0x00,
        0x44, 0x00, 0x00, 0x00, 0x08, 0x00, 0x33, 0x00, 0xff, 0xff, 0x00, 0x00,
        0x08, 0x00, 0x1b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x1e, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x3d, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        ,
        ...
        0x0c, 0x00, 0x1e, 0x00, 0x64, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x0c, 0x00, 0x1f, 0x00, 0x90, 0x65, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x0c, 0x00, 0x20, 0x00, 0x9c, 0x63, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x0c, 0x00, 0x21, 0x00, 0xd4, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x0c, 0x00, 0x22, 0x00, 0xe8, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x0c, 0x00, 0x23, 0x00, 0x35, 0x0c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        0x14, 0x00, 0x05, 0x00, 0xff, 0xff, 0x00, 0x00, 0x05, 0x04, 0x26, 0x00,
        0xce, 0x88, 0x00, 0x00, 0xe8, 0x03, 0x00, 0x00, 0xf4, 0x00, 0x02, 0x00,
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x3e, 0x80, 0x04, 0x00, 0x41, 0x80,
    ];
    ...
    let expected = LinkMessage {
        ...
        attributes: vec![
            LinkAttribute::IfName("brstp0".to_string()),
            LinkAttribute::TxQueueLen(1000),
            LinkAttribute::OperState(State::Down),
            LinkAttribute::Mode(LinkMode::Default),
            LinkAttribute::NetnsImmutable(true),
            LinkAttribute::Mtu(1500),
            LinkAttribute::MinMtu(68),
            LinkAttribute::MaxMtu(65535),
            LinkAttribute::Group(0),
            ...
            LinkAttribute::ProtoDown(0),
            LinkAttribute::Address(vec![102, 166, 196, 142, 116, 102]),
            ...
            LinkAttribute::LinkInfo(vec![
                ...
                LinkInfo::Data(InfoData::Bridge(vec![
                    ...
                    InfoBridge::ForwardDelay(1500),
                    InfoBridge::HelloTime(200),
                    InfoBridge::MaxAge(2000),
                    InfoBridge::AgeingTime(30000),
                    InfoBridge::StpState(BridgeStpState::Disabled),
                    InfoBridge::Priority(32768),
                    InfoBridge::VlanFiltering(false),
                    InfoBridge::GroupFwdMask(0),
                    ...
                    InfoBridge::TopologyChange(0),
                    InfoBridge::TopologyChangeDetected(0),
                    InfoBridge::GroupAddr([1, 128, 194, 0, 0, 0]),
                    InfoBridge::MultiBoolOpt(BridgeBooleanOptions {
                        value: BridgeBooleanOptionFlags::empty(),
                        mask: BridgeBooleanOptionFlags::NoLinkLocalLearn
                            | BridgeBooleanOptionFlags::VlanMulticastSnooping
                            ...
                            | BridgeBooleanOptionFlags::FdbLocalVlan0,
                    }),
                    InfoBridge::FdbNLearned(0),
                    InfoBridge::FdbMaxLearned(0),
                    InfoBridge::StpMode(BridgeStpMode::Kernel),
                    InfoBridge::VlanProtocol(VlanProtocol::Ieee8021Q),
                    InfoBridge::VlanDefaultPvid(1),
                    InfoBridge::VlanStatsEnabled(false),
                    InfoBridge::VlanStatsPerPort(false),
                    ...
                    InfoBridge::MulticastIgmpVersion(2),
                    InfoBridge::MulticastMldVersion(1),
                    InfoBridge::MulticastLastMemberInterval(100),
                    InfoBridge::MulticastMembershipInterval(26000),
                    InfoBridge::MulticastQuerierInterval(25500),
                    InfoBridge::MulticastQueryInterval(12500),
                    InfoBridge::MulticastQueryResponseInterval(1000),
                    InfoBridge::MulticastStartupQueryInterval(3125),
                    InfoBridge::NfCallIpTables(false),
                    InfoBridge::NfCallIp6Tables(false),
                    InfoBridge::NfCallArpTables(false),
                ])),
...
// The nlmon capture of 6.19 kernel reply after command:
//      sudo ip link show virbr0
#[test]
fn test_bridge_netns_immutable() {
    let raw = vec![
        0x00, 0x00, 0x01, 0x00, 0x04, 0x00, 0x00, 0x00, 0x43, 0x10, 0x01, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x0b, 0x00, 0x03, 0x00, 0x76, 0x69, 0x72, 0x62,
        0x72, 0x30, 0x00, 0x00, 0x08, 0x00, 0x0d, 0x00, 0xe8, 0x03, 0x00, 0x00,
        ...
        ,
        ...
        ,
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
        0x30, 0x01, 0x0a, 0x00, 0x08, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x14, 0x00, 0x05, 0x00, 0xff, 0xff, 0x00, 0x00, 0x1d, 0x04, 0x00, 0x00,
        0xc5, 0x62, 0x00, 0x00, 0xe8, 0x03, 0x00, 0x00, 0xf4, 0x00, 0x02, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0xdc, 0x05, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x01, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xa0, 0x0f, 0x00, 0x00,
    ...
    let expected = LinkMessage {
        ...
        attributes: vec![
            LinkAttribute::IfName("virbr0".to_string()),
            LinkAttribute::TxQueueLen(1000),
            LinkAttribute::OperState(State::Up),
            LinkAttribute::Mode(LinkMode::Default),
            LinkAttribute::NetnsImmutable(true),
            ...
            LinkAttribute::Other(DefaultNla::new(69, vec![0, 0])),
            LinkAttribute::ProtoDown(0),
            LinkAttribute::Address(vec![82, 84, 0, 176, 82, 209]),
            LinkAttribute::Broadcast(vec![255, 255, 255, 255, 255, 255]),
            LinkAttribute::Xdp(vec![LinkXdp::Attached(XdpAttached::None)]),
            LinkAttribute::LinkInfo(vec![
                LinkInfo::Kind(InfoKind::Bridge),
                LinkInfo::Data(InfoData::Bridge(vec![
                    ...
                    InfoBridge::TcnTimer(0),
                    InfoBridge::TopologyChangeTimer(0),
                    InfoBridge::GcTimer(19620),
                    InfoBridge::ForwardDelay(200),
                    InfoBridge::HelloTime(200),
                    InfoBridge::MaxAge(2000),
                    InfoBridge::AgeingTime(30000),
                    InfoBridge::StpState(BridgeStpState::KernelStp),
                    InfoBridge::Priority(32768),
                    InfoBridge::VlanFiltering(false),
                    InfoBridge::GroupFwdMask(0),
                    InfoBridge::BridgeId(BridgeId {
                        priority: 32768,
                        address: [82, 84, 0, 176, 82, 209],
                    }),
                    InfoBridge::RootId(BridgeId {
                        priority: 32768,
                        address: [82, 84, 0, 176, 82, 209],
            ...
            LinkAttribute::Qdisc("htb".to_string()),
            LinkAttribute::AfSpecUnspec(vec![
                AfSpecUnspec::Inet(vec![AfSpecInet::DevConf(InetDevConf {
                    forwarding: 1,
                    mc_forwarding: 0,
                ...
                AfSpecUnspec::Inet6(vec![
                    ...
                    AfSpecInet6::Token("::".parse().unwrap()),
                    AfSpecInet6::AddrGenMode(In6AddrGenMode::Eui64),
                ]),
            ]),
            LinkAttribute::Map(Map {
