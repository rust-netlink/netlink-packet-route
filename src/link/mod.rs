...
pub use self::{
    ...
    link_info::{
        ...
        InfoGeneve, InfoGre, InfoGre6, InfoGtp, InfoHsr, InfoIpTunnel,
        ...
        MacVlanMode, MacVtapMode, MiiStatus, NetkitMode, NetkitPolicy,
        NetkitScrub, TunnelEncapFlags, TunnelEncapType, VlanFlags,
        VlanQosMapping,
    },
