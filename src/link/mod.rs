...
pub use self::{
    ...
    link_info::{
        ...
        InfoVlan, InfoVrf, InfoVrfPort, InfoVti, InfoVxcan, InfoVxlan,
        InfoWwan, InfoXfrm, Ip6TunnelFlags, IpVlanFlags, IpVlanMode,
        IpVtapFlags, IpVtapMode, IpoibMode, LacpState, LinkInfo, LinkXstats,
