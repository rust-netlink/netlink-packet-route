...
pub use self::link_info::{
    ...
    InfoPortKind, InfoTun, InfoVeth, InfoVrf, InfoVrfPort, InfoVti, InfoVxcan,
    InfoVxlan, InfoXfrm, Ip6TunnelFlags, IpVlanFlags, IpVlanMode, IpVtapFlags,
    IpVtapMode, IpoibMode, LinkXstats, MacSecCipherId, MacSecOffload,
    MacSecValidate, MacVlanFlags, MacVlanMacAddressMode, MacVlanMode,
    MacVtapFlags, MacVtapMacAddressMode, MacVtapMode, MiiStatus, NetkitMode,
