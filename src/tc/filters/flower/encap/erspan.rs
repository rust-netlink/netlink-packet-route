...
const TCA_FLOWER_KEY_ENC_OPT_ERSPAN_VER: u16 = 1; /* u8 */
const TCA_FLOWER_KEY_ENC_OPT_ERSPAN_INDEX: u16 = 2; /* be32 */
const TCA_FLOWER_KEY_ENC_OPT_ERSPAN_DIR: u16 = 3; /* u8 */
const TCA_FLOWER_KEY_ENC_OPT_ERSPAN_HWID: u16 = 4; /* u8 */
